                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent" mc:edit="body_content">
                                                <h1>{{ $data->subjectLine }}</h1>
                                                <b>Dear {{ $data->name }},</b><br><br>
                                                
                                                Thank you for doing business with Hardwires.<br><br>
                                                Please find your {{ $data->action }} invoice attached herein. Should you encounter any problems, please email: <a href="mailto:discover@hardwires.co.za">discover@hardwires.co.za</a>
