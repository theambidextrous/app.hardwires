...
<head>
  ...
  <title>hardwires mail center</title>
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                {{ date('m/d/Y') }}<br />
                                <br />
                                <span class="header-sm">Due Date</span><br />
                                {{ $data['due_date'] }}<br />
                                <br />
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight: bold;">Hardwires Assessment</span> <br />
                            Questionnaires
                          </td>
                        </tr>
                      </table>
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">R{{ $data['cost'] }}</span> <br />
                      <span class="total-space">R0.00</span>  <br />
                      <span class="total-space">N/A</span>  <br />
                      <span class="total-space" style="font-weight:bold; color: #4d4d4d">R{{ $data['cost'] }}</span>
                    </td>
                  </tr>  
                </table>
              </td>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>Amajonbjob Co Pty Ltd ta Hardwires</strong><br />
              Plot 104 Brandvlei road <br />
              Magaliesburg <br /><br />
            </td>
          </tr>
        </table>
