        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    ...
                    <h2 class="alert alert-warning">Please make sure that your internet is stable.</h2>
                    @if( $isClothingBank )
                        <h2 class="alert alert-primary">Dear Client, by completing this questionnaire, you  consent to your graphs being accessed by both The Clothing Bank and Hardwires.</h2>
                    @endif
